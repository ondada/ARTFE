...
<body>
  ...
  <div class="login-form">
    <form method=post action="insertOk.jsp" name="insert">
    <center><h2><b>회원가입</b></h2></center>
    <br>
   	  <h4><b>아이디 <font color="#514FF0">*</font></b><a href="javascript:checkID()"> <input type="button"  value="아이디 중복확인" style="width:100px; height:30px; padding:6px; margin-bottom:4px; font-size:12px; font-weight:600; background-color:white; color:black; border:1px solid #b0b0b0; float:right; cursor: pointer; font-family: Pretendard Variable, sans-serif;"></a></h4>
...
<div>
            <ul class="join_box">
                <li class="checkBox check01">
                    <ul class="clearfix">
                        <li>이용약관, 개인정보 수집 및 이용, 예매 정보 수신(선택)에 모두 동의합니다.</li>
                        <li class="checkAllBtn">
                            <input type="checkbox" name="chkAll" id="cbx_chkAll" class="chkAll" style="accent-color:#514FF0">
                        </li>
                    </ul>
                </li>
                <li class="checkBox check02">
                    <ul class="clearfix">
                        <li>[필수] 만 14세 이상입니다. </li>
                        <li class="checkBtn">
                            <input type="checkbox" name="chk" style="accent-color:#514FF0"> 
                        </li>
                    </ul>
                    <textarea name="" id="" style="font-family: Pretendard Variable, sans-serif; font-size:15px;">여러분을 환영합니다.
아트페 서비스 (이하 ‘서비스’)를 이용해 주셔서 감사합니다. 본 약관은 다양한 아트페 서비스의 이용과 관련하여 아트페 서비스를 제공하는 아트페 주식회사(이하 ‘아트페’)와 이를 이용하는 아트페 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 아트페 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
       </textarea>
                </li>
