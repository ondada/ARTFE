...
<%
   ...
   String jsql1 = "select * from event where e_no = 'A34'";   
   PreparedStatement pstmt1 = con.prepareStatement(jsql1);
   ResultSet rs1 = pstmt1.executeQuery();

   rs1.next();

   String jsql2 = "select * from event where e_no = 'A35'";   
   PreparedStatement pstmt2 = con.prepareStatement(jsql2);
   ResultSet rs2 = pstmt2.executeQuery();
   rs2.next();

   String jsql3 = "select * from event where e_no = 'A24'";   
   PreparedStatement pstmt3 = con.prepareStatement(jsql3);
   ResultSet rs3 = pstmt3.executeQuery();
   rs3.next();

   String jsql4 = "select * from event where e_no = 'A25'";   
   PreparedStatement pstmt4 = con.prepareStatement(jsql4);
   ResultSet rs4 = pstmt4.executeQuery();
   rs4.next();

   String jsql5 = "select * from event where e_no = 'A11'";   
   PreparedStatement pstmt5 = con.prepareStatement(jsql5);
   ResultSet rs5 = pstmt5.executeQuery();
   rs5.next();

   String jsql6 = "select * from event where e_no = 'A42'";   
   PreparedStatement pstmt6 = con.prepareStatement(jsql6);
   ResultSet rs6 = pstmt6.executeQuery();
   rs6.next();

   String jsql7 = "select * from event where e_no = 'A36'";   
   PreparedStatement pstmt7 = con.prepareStatement(jsql7);
   ResultSet rs7 = pstmt7.executeQuery();
   rs7.next();

   String jsql8 = "select * from event where e_no = 'A41'";   
   PreparedStatement pstmt8 = con.prepareStatement(jsql8);
   ResultSet rs8 = pstmt8.executeQuery();
   rs8.next();


  String jsql9 = "select * from event where e_no = 'A12'";   
   PreparedStatement pstmt9 = con.prepareStatement(jsql9);
   ResultSet rs9 = pstmt9.executeQuery();
   rs9.next();

   String jsql10 = "select * from event where e_no = 'A43'";   
   PreparedStatement pstmt10 = con.prepareStatement(jsql10);
   ResultSet rs10 = pstmt10.executeQuery();
   rs10.next();

   String jsql11 = "select * from event where e_no = 'A44'";   
   PreparedStatement pstmt11 = con.prepareStatement(jsql11);
   ResultSet rs11 = pstmt11.executeQuery();
   rs11.next();

   String jsql12 = "select * from event where e_no = 'A45'";   
...
<div id="sectionGenre">
  <table>
    ...
    <tr>
      <td><span id="sebu"><a href="exhi_2.jsp">대전/세종/충청</a></span></td>
    </tr>
    <tr>
      <td><span id="sebu"><a href="exhi_3.jsp"><b><span style="color:#514FF0">광주/전라&nbsp;></span></a> </b></span></td>
    </tr>
	<tr>
...
<div id="sectionGenre">
  <table>
    ...
    <tr>
      <td><span style="font-size: 17px;"><a href="exhi_2.jsp">대전/세종/충청</a></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="exhi_3.jsp"><b><span style="color:#514FF0">광주/전라&nbsp;></span></a> </b></span></td>
    </tr>
	<tr>
