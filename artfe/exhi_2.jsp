...
String e_no5 = rs5.getString("e_no");
	...
	String e_no17 = rs17.getString("e_no");
     String e_name17 =  rs17.getString("e_name");      
    String e_term17 =  rs17.getString("e_term");      
    String e_place17 =  rs17.getString("e_place");   
    String e_price17 = rs17. getString("e_price");

	DecimalFormat df17 = new DecimalFormat("###,###");
	int sum17 = Integer.parseInt(rs17.getString("e_price"));

	String e_no18 = rs18.getString("e_no");
     String e_name18 =  rs18.getString("e_name");      
    String e_term18 =  rs18.getString("e_term");      
    String e_place18 =  rs18.getString("e_place");   
    String e_price18 = rs18. getString("e_price");

	DecimalFormat df18 = new DecimalFormat("###,###");
	int sum18 = Integer.parseInt(rs18.getString("e_price"));

	String e_no19 = rs19.getString("e_no");
     String e_name19 =  rs19.getString("e_name");      
    String e_term19 =  rs19.getString("e_term");      
    String e_place19 =  rs19.getString("e_place");   
    String e_price19 = rs19. getString("e_price");

	DecimalFormat df19 = new DecimalFormat("###,###");
	int sum19 = Integer.parseInt(rs19.getString("e_price"));

	String e_no20 = rs20.getString("e_no");
     String e_name20 =  rs20.getString("e_name");      
    String e_term20 =  rs20.getString("e_term");      
    String e_place20 =  rs20.getString("e_place");   
    String e_price20 = rs20. getString("e_price");

	DecimalFormat df20 = new DecimalFormat("###,###");
	int sum20 = Integer.parseInt(rs20.getString("e_price"));
...
<div id="sectionGenre">
  <table>
    ...
    <tr>
      <td><span style="font-size: 17px;"><a href="exhi_1.jsp">서울/경기/인천</a></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="exhi_2.jsp"><b><span style="color:#514FF0">대전/세종/충청&nbsp;></span></a> </b></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="exhi_3.jsp">광주/전라</a></span></td>
    </tr>
	<tr>
      <td><span style="font-size: 17px;"><a href="exhi_4.jsp">부산/경상</a></span></td>
    </tr>
  </table>
  </div>
...
<div id="sectionGenre">
  <table>
    ...
    <tr>
      <td><span id="sebu"><a href="exhi_1.jsp">서울/경기/인천</a></span></td>
    </tr>
    <tr>
      <td><span id="sebu"><a href="exhi_2.jsp"><b><span style="color:#514FF0">대전/세종/충청&nbsp;></span></a> </b></span></td>
    </tr>
    <tr>
      <td><span id="sebu"><a href="exhi_3.jsp">광주/전라</a></span></td>
    </tr>
	<tr>
      <td><span id="sebu"><a href="exhi_4.jsp">부산/경상</a></span></td>
    </tr>
  </table>
  </div>
...
<a href="sangse.jsp?e_no=<%=e_no17%>">
   <div id="sectionPic" style="background-image: url(images/<%=e_no17%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
         
      <div id="sectionContent">
        <h2><%= e_name17 %></h2>
        <p style="color:gray;"><%=e_term17 %></p>
        <p><%=e_place17 %></p>
        <br><br><br>
        <b><h3 style="color:#514FF0"><%=df17.format(sum17)%>원</h3></b><br><br><br><br>
            
    </div>
   </a>
     
       <a href="sangse.jsp?e_no=<%=e_no18%>">
         <div id="sectionPic" style="background-image: url(images/<%=e_no18%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
 
         <div id="sectionContentRight">
        <h2><%= e_name18 %></h2>
        <p style="color:gray;"><%=e_term18 %></p>
        <p><%=e_place18 %></p>
        <br><br><br>
       <b><h3 style="color:#514FF0"><%=df2.format(sum18)%>원</h3></b>
      
    </div>
      </a>

     <a href="sangse.jsp?e_no=<%=e_no19%>">
   <div id="sectionPicBottom" style="background-image: url(images/<%=e_no19%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
         
      <div id="sectionContent">
        <h2><%= e_name19 %></h2>
        <p style="color:gray;"><%=e_term19 %></p>
        <p><%=e_place19 %></p>
        <br><br><br>
        <b><h3 style="color:#514FF0"><%=df19.format(sum19)%>원</h3></b>
            
    </div>
   </a>
     
       <a href="sangse.jsp?e_no=<%=e_no20%>">
         <div id="sectionPic" style="background-image: url(images/<%=e_no20%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
 
         <div id="sectionContentRight">
        <h2><%= e_name20 %></h2>
        <p style="color:gray;"><%=e_term20 %></p>
        <p><%=e_place20 %></p>
        <br><br><br>
       <b><h3 style="color:#514FF0"><%=df20.format(sum20)%>원</h3></b>
    </div>
      </a>
      </div>
</section>
...
<div id="pagination" style="margin-left:40px;">
