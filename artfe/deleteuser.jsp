...
<br><br>
 <a href="deleteuserResult.jsp?id=<%=id%>"><input type="button" class="userdelete" value="회원 탈퇴" onClick="checkValue()" style="cursor:pointer"></a> &nbsp;&nbsp;
  <a href="main.jsp"><input type="reset" class="userdeleteno" value="취소" onClick="location.href='main.jsp'" style="cursor:pointer"> </a>
  <br><br><br><br>
  <br><br>
  </center>
</div>
