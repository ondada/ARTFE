...
<%
   ...
   //  조회하고자하는 특정 ctgType값을 넘겨 받아옴 
     ...
     String jsql1 = "select * from event where e_no = 'A13'";   
   PreparedStatement pstmt1 = con.prepareStatement(jsql1);
   ResultSet rs1 = pstmt1.executeQuery();

   rs1.next();

   String jsql2 = "select * from event where e_no = 'A14'";   
   PreparedStatement pstmt2 = con.prepareStatement(jsql2);
   ResultSet rs2 = pstmt2.executeQuery();
   rs2.next();

   String jsql3 = "select * from event where e_no = 'A20'";   
   PreparedStatement pstmt3 = con.prepareStatement(jsql3);
   ResultSet rs3 = pstmt3.executeQuery();
   rs3.next();

   String jsql4 = "select * from event where e_no = 'A23'";   
   PreparedStatement pstmt4 = con.prepareStatement(jsql4);
   ResultSet rs4 = pstmt4.executeQuery();
   rs4.next();

   String jsql5 = "select * from event where e_no = 'A27'";   
   PreparedStatement pstmt5 = con.prepareStatement(jsql5);
   ResultSet rs5 = pstmt5.executeQuery();
   rs5.next();

   String jsql6 = "select * from event where e_no = 'A28'";   
   PreparedStatement pstmt6 = con.prepareStatement(jsql6);
   ResultSet rs6 = pstmt6.executeQuery();
   rs6.next();

   String jsql7 = "select * from event where e_no = 'A33'";   
   PreparedStatement pstmt7 = con.prepareStatement(jsql7);
   ResultSet rs7 = pstmt7.executeQuery();
   rs7.next();

   String jsql8 = "select * from event where e_no = 'A38'";   
   PreparedStatement pstmt8 = con.prepareStatement(jsql8);
   ResultSet rs8 = pstmt8.executeQuery();
   rs8.next();


  String jsql9 = "select * from event where e_no = 'A39'";   
   PreparedStatement pstmt9 = con.prepareStatement(jsql9);
   ResultSet rs9 = pstmt9.executeQuery();
   rs9.next();

   String jsql10 = "select * from event where e_no = 'A40'";   
   PreparedStatement pstmt10 = con.prepareStatement(jsql10);
   ResultSet rs10 = pstmt10.executeQuery();
   rs10.next();

   String jsql11 = "select * from event where e_no = 'A49'";   
   PreparedStatement pstmt11 = con.prepareStatement(jsql11);
   ResultSet rs11 = pstmt11.executeQuery();
   rs11.next();

   String jsql12 = "select * from event where e_no = 'A56'";   
...
<div id="sectionGenre">
  <table>
	...
	<tr>
      <td><span id="sebu"><a href="exhi_4.jsp"><b><span style="color:#514FF0">부산/경상&nbsp;></span></a> </b></span></td>
    </tr>
  </table>
  </div>
...
<div id="sectionGenre">
  <table>
	...
	<tr>
      <td><span style="font-size: 17px;"><a href="exhi_4.jsp"><b><span style="color:#514FF0">부산/경상&nbsp;></span></a> </b></span></td>
    </tr>
  </table>
  </div>
