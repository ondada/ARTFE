...
<%
	...
	String jsql1 = "select * from event where e_no = 'B05'";   
	PreparedStatement pstmt1 = con.prepareStatement(jsql1);
	ResultSet rs1 = pstmt1.executeQuery();
	rs1.next();

	String jsql2 = "select * from event where e_no = 'B06'";   
	PreparedStatement pstmt2 = con.prepareStatement(jsql2);
	ResultSet rs2 = pstmt2.executeQuery();
	rs2.next();

	String jsql3 = "select * from event where e_no = 'B07'";   
	PreparedStatement pstmt3 = con.prepareStatement(jsql3);
	ResultSet rs3 = pstmt3.executeQuery();
	rs3.next();

	String jsql4 = "select * from event where e_no = 'B08'";   
...
<div id="sectionGenre">
  <table>
    ...
    <tr>
      <td><span style="font-size: 17px;"><b><a href="#"><span style="color:#514FF0">서울
        &nbsp;&nbsp;&nbsp;></span></a> </b></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="#">경기 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="#">인천 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
    <tr>
      <td><span style="font-size: 17px;"><a href="#">부산 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
   <tr>
      <td><span style="font-size: 17px;"><a href="#">강원 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
	<tr>
      <td><span style="font-size: 17px;"><a href="#">충청 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
	<tr>
      <td><span style="font-size: 17px;"><a href="#">전라 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
    <tr style="border:none;">
      <td style="border:none; "><span style="font-size: 17px;"><a href="#">제주 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></td>
    </tr>
  </table>
  </div>
...
<div id="contentNav">
<p>축제 | <b>서울</b></p>
<p style="font-size:17px; color:gray">Festivals in Seoul</p>
</div>
   ...
   <div id="sectionPic" style="background-image: url(images/<%=e_no4%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
      ...
      <div id="sectionContent">
        ...
        <p><%=e_place4 %></p>
        <br><br><br>
        <b><h3 style="color:#514FF0"><%=e_price4%>원</h3></b><br><br><br><br>
   ...
   <div id="sectionPicBottom" style="background-image: url(images/<%=e_no3%>.jpg); background-size: cover; background-repeat: no-repeat;"></div>
      ...
      <div id="sectionContent">
       ...
       <a href="sangse.jsp?e_no=<%=e_no1%>">
        ...
        <p><%=e_place1 %></p>
        <br><br><br>
       <b><h3 style="color:#514FF0"><%=e_price1%>원</h3></b>
